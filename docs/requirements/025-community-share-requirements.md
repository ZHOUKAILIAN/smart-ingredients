...
- **编号**: FR-002
- **优先级**: 高
- **描述**: 在分析结果页与历史详情页提供“分享到社区”入口；已分享时不显示分享按钮。
- **验收标准**:
  - [ ] 未分享记录在分析结果页可发起分享
  - [ ] 未分享记录在历史详情页可发起分享
  - [ ] 已分享记录不显示分享按钮（可显示“已分享”状态文本）
  - [ ] 分享过程中提供加载提示与失败提示
...
- **编号**: FR-008
- **优先级**: 中
- **描述**: 社区列表与社区详情页的发布时间需格式化展示为 `YYYY-MM-DD HH:mm:ss`。
- **验收标准**:
  - [ ] 社区列表时间显示为 `YYYY-MM-DD HH:mm:ss`
  - [ ] 社区详情页时间显示为 `YYYY-MM-DD HH:mm:ss`

### 需求 7：社区页面抬头
- **编号**: FR-009
- **优先级**: 低
- **描述**: 社区页面抬头不显示“社区”字样（标题留空）。
- **验收标准**:
  - [ ] 社区页面抬头不显示“社区”
...
- **编号**: FR-007
- **优先级**: 中
- **描述**: 已分享的历史记录需标记分享状态；删除操作在社区页面完成。
- **验收标准**:
  - [ ] 已分享记录显示“已分享”状态（无操作按钮）
  - [ ] 删除后状态同步更新
